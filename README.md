...
Repos are here: https://dl.rockylinux.org/pub/rocky/8/
...
-------------------------------------------------------------------------------
Hashes for old shim will be provided to Microsoft and older grub is disallowed to boot via the new increased global generation number
...
-------------------------------------------------------------------------------
Jump from shim-15.4 + patches requested by the review board #194 to shim-15.6
...
grub.rocky,2,Rocky Linux,grub2,2.02-123.el8_6.8,mail:security@rockylinux.org
...
-------------------------------------------------------------------------------
grub2-2.02-123.el8_6.8 https://git.rockylinux.org/staging/rpms/grub2/-/tree/r8 which is comes from RHEL8
...
-------------------------------------------------------------------------------
Last accepted submission for Rocky Linux 8 #194
